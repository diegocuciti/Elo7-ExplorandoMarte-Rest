...
//	@Path("/processarDados")
//	@Produces(MediaType.APPLICATION_JSON)
//	public @ResponseBody List<DestinoSonda> processarDados(@QueryParam("planalto") String planalto, @QueryParam("sondas") String sondas) throws CoordenadaForaDoEixoDoPlanaltoException, CamposInvalidosException {

	@GET
	@Path("/processarDados")
	@Produces(MediaType.APPLICATION_JSON)
	public @ResponseBody List<DestinoSonda> processarDados(@Context UriInfo infoUri) throws CoordenadaForaDoEixoDoPlanaltoException, CamposInvalidosException {
